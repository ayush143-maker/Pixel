  ...
  return (
    <section id="pricing" className="section">
      ...
      <motion.div
        ...
        className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 items-start"
      >
        {plans.map((plan) => (
          <motion.div
            key={plan.name}
            ...
            className={`glass-card p-10 relative overflow-hidden ${
              plan.featured
                ? 'border-accent/40 shadow-[0_0_40px_rgba(139,92,246,0.1)]'
                : ''
            }`}
          >
            {plan.featured && (
              <div className="absolute top-4 -right-10 bg-gradient-to-r from-accent to-accent-secondary text-white text-[11px] font-bold uppercase tracking-wider py-1.5 px-12 rotate-45">
                Most Popular
              </div>
            )}
            ...
            <div className="font-heading text-5xl font-bold text-text-primary mb-2">
              {plan.price}

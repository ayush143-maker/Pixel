      ...
      >
        <div className="max-w-[1200px] mx-auto flex items-center justify-between">
          ...
          <button
            ...
            className="md:hidden bg-none border-none text-text-primary cursor-pointer p-2"
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-[999] bg-background/98 backdrop-blur-3xl flex flex-col items-center justify-center gap-8"
          >
            <button
